...
Results:
    ...
    Evaluation in %:
                          score      time
    pipeline                             
    CSP_default_no_or  0.754968  0.190051
    CSP_default_or     0.753111  0.232424
    TSLR               0.749520  0.282348
    new_best           0.754815  1.768023
    no_CSP_no_or       0.752689  1.999484
    no_or              0.757475  1.744133
    or_no_init         0.756141  1.813992
...
pipelines["CSP_default_or"] = make_pipeline(
    Covariances("oas"),
    CSP(nfilter=10,log=False),
    MeanFieldNew(power_list=power_means11,
              method_label="lda",
              n_jobs=mdm_mf_jobs,
              euclidean_mean         = False, #default = false
