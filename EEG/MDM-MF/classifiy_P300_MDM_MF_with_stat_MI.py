...
#12 MI datasets
from moabb.datasets import BNCI2014_001, Zhou2016, BNCI2015_001, BNCI2014_002, BNCI2014_004, BNCI2015_004, AlexMI, Weibo2014, Cho2017, GrosseWentrup2009, PhysionetMI, Shin2017A
...
BNCI2014_001, Zhou2016, BNCI2015_001, BNCI2014_002, BNCI2014_004, BNCI2015_004, AlexMI, Weibo2014, Cho2017, GrosseWentrup2009, PhysionetMI, Shin2017A
    
#requires at least 3 subjects per dataset
datasets = [Zhou2016(),
            BNCI2014_001(),
            BNCI2015_001(), 
...
for d in datasets:
    ...
    print(name)
    if name not in [(lambda x: type(x).__name__)(x) for x in paradigm.datasets]:
