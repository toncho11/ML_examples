...
#too slow
# pipelines["CDF_or"] = make_pipeline(
#     Covariances("oas"),
...
#               distance_strategy      = "custom_distance_function",
...
pipelines["AD1_or_th4"] = make_pipeline(
    Covariances("oas"),
    CustomCspTransformer(nfilter = 10),
    MeanFieldNew(power_list=power_means12,
              method_label="lda",
...
# pipelines["MF_orig_csp_sm"] = make_pipeline(
#     Covariances("oas"),
#     CustomCspTransformer(nfilter = 10),
...
# # pipelines["MF_orig_im"] = make_pipeline(
# #     Covariances("oas"),
# #     MeanField_orig(power_list=power_means,
...
# pipelines["MF_orig_sm"] = make_pipeline(
#     Covariances("oas"),
#     MeanField_orig(power_list=power_means,
#                     method_label="sum_means"
#               ),
