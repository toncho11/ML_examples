...
# pipelines["XDAWNCov+MF_orig"] = make_pipeline(
#     XdawnCovariances(),
...
# pipelines["XDAWNCov+RMF"] = make_pipeline(
...
# pipelines["XDAWNCov+RMF_ro"] = make_pipeline(
#     XdawnCovariances(nfilter=4,estimator="oas"),
#     MeanFieldNew(power_list=power_means11,
#                 method_label="lda",
#                 n_jobs=mdm_mf_jobs,
...
pipelines["X+MDM"] = make_pipeline(
    XdawnCovariances(),
    MDM(metric="riemann"),
)

pipelines["X+MDM_OR"] = make_pipeline(
    XdawnCovariances(),
    MDM(metric="riemann_or"),
)

# pipelines["COV+RMF"] = make_pipeline(
#     Covariances("oas"),
#     MeanFieldNew(power_list=power_means11,
#               # method_label="lda",
#               # n_jobs=mdm_mf_jobs,
...
# might fail
# pipelines["ErpCOV+RMF"] = make_pipeline(
#     ERPCovariances(),
#     MeanFieldNew(power_list=power_means11,
#               # method_label="lda",
#               # n_jobs=mdm_mf_jobs,
...
pipelines["X+TS+SVC"] = make_pipeline(
    XdawnCovariances(),
    TangentSpace(),
    SVC()
)

pipelines["X+TS+SVC_OR"] = make_pipeline(
    XdawnCovariances(),
