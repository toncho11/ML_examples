...
def heavy_benchmark(pipelines, max_n_subjects = -1, overwrite = False):
    '''
...
results = heavy_benchmark(pipelines, max_n_subjects = 30)
...
# ----------------
#
# Here we plot the results to compare the pipelines
