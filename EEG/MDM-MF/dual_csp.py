...
from enchanced_mdm_mf_tools import CustomCspTransformer, CustomCspTransformer2, CustomCspTransformer3, CustomCspTransformer4, CustomCspTransformer5,CustomCspTransformer6, CustomCspTransformer7
...
#new best
pipelines["new_best_no_or"] = make_pipeline(
    Covariances("oas"),
...
# pipelines["CSP_dual"] = make_pipeline(
#     Covariances("oas"),
#     CSP(nfilter = 32, metric="euclid", log=False),
#     CSP(metric = "ale", nfilter=10, log=False, maxiter = 2, n_iter_max = 2), # maxiter = 50, n_iter_max = 100)
#     MeanFieldNew(power_list=power_means11,
#               method_label="lda",
#               n_jobs=mdm_mf_jobs,
#               euclidean_mean         = False, #default = false
...
#                    score      time
# pipeline                          
# CSP_dual        0.817947  0.323841
# TSLR            0.823830  0.402167
# new_best_no_or  0.817115  1.541570

pipelines["CSP3_no_or"] = make_pipeline(
    Covariances("oas"),
    CustomCspTransformer3(),
    MeanFieldNew(power_list=power_means11,
              method_label="lda",
              n_jobs=mdm_mf_jobs,
              euclidean_mean         = False, #default = false
...
pipelines["CSP3_or"] = make_pipeline(
    Covariances("oas"),
    CustomCspTransformer3(),
    MeanFieldNew(power_list=power_means11,
              method_label="lda",
...
pipelines["CSP4_or"] = make_pipeline(
    Covariances("oas"),
    CustomCspTransformer4(),
    MeanFieldNew(power_list=power_means11,
              method_label="lda",
              n_jobs=mdm_mf_jobs,
              euclidean_mean         = False, #default = false
...
pipelines["CSP5_or"] = make_pipeline(
    Covariances("oas"),
    CustomCspTransformer5(),
    MeanFieldNew(power_list=power_means11,
              method_label="lda",
              n_jobs=mdm_mf_jobs,
              euclidean_mean         = False, #default = false
...
pipelines["CSP6_or"] = make_pipeline(
    Covariances("oas"),
    CustomCspTransformer6(),
    MeanFieldNew(power_list=power_means11,
              method_label="lda",
              n_jobs=mdm_mf_jobs,
              euclidean_mean         = False, #default = false
...
pipelines["CSP7_or"] = make_pipeline(
    Covariances("oas"),
    CustomCspTransformer7(),
    MeanFieldNew(power_list=power_means11,
              method_label="lda",
              n_jobs=mdm_mf_jobs,
              euclidean_mean         = False, #default = false
