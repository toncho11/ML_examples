...
# pipelines["CSP_DIAG_AJD_MDM_MF_PM12"] = make_pipeline(
#     Covariances("oas"),
#     CustomCspTransformer(metric_p="not used", nfilter = 10),
#     Diagonalizer(diagonalization="ajd_pham"),
...
# pipelines["ajd_pham_linalg"] = make_pipeline(
#     Covariances("oas"),
#     CustomCspTransformer(metric_p="not used", nfilter = 10),
#     #Diagonalizer(method="rjd"),
#     Diagonalizer(diag_method="ajd_pham",norm_method="linalg"),
#     MeanFieldNew(power_list=power_means12,
#               method_label="lda",
#               n_jobs=mdm_mf_jobs,
#               euclidean_mean         = False, #default = false
...
# pipelines["ajd_pham_mean_std"] = make_pipeline(
#     Covariances("oas"),
#     CustomCspTransformer(metric_p="not used", nfilter = 10),
#     #Diagonalizer(method="rjd"),
...
# pipelines["csp_pm12_rjd_ro"] = make_pipeline(
#     Covariances("oas"),
#     CustomCspTransformer(metric_p="not used", nfilter = 10),
#     #Diagonalizer(method="rjd"),
...
# pipelines["csp_rjd_pm7"] = make_pipeline(
#     Covariances("oas"),
#     CustomCspTransformer(metric_p="not used", nfilter = 10),
#     #Diagonalizer(method="rjd"),
#     Diagonalizer(diag_method="rjd",norm_method="not used"),
...
# pipelines["csp_rjd_pm12"] = make_pipeline(
#     Covariances("oas"),
#     CustomCspTransformer(metric_p="not used", nfilter = 10),
#     Diagonalizer(norm_method="rjd"),
#     #Diagonalizer(diag_method="rjd",norm_method="not used"),
#     #Diagonalizer(diag_method="ajd_pham",norm_method="mean_std"),
#     MeanFieldNew(power_list=power_means12,
#               method_label="lda",
...
# pipelines["rjd_pm12"] = make_pipeline(
#     Covariances("oas"),
#     #CustomCspTransformer(metric_p="not used", nfilter = 10),
#     #Diagonalizer(method="rjd"),
#     Diagonalizer(diag_method="rjd",norm_method="not used"),
