"""
====================================================================
ERP EEG classification with MOABB, Riemannian Geometry and Tensor Flow
====================================================================

It uses datasets from MOABB.
It creates one pipeline that uses Tensor Flow for classification and two standard pipelines for comparison.
The provided NN is unoptimized. It is more of a Proof of Concept.
Currently the "input_shape" of the NN must be adjusted for each dataset.
...
def create_keras_model():
    ...
    model = keras.Sequential([
      keras.layers.Dense(32, activation=tf.nn.relu,
                         input_shape=(516,)), #currently this line must be adjusted for each dataset
...
clf_tf = KerasClassifier(build_fn=create_keras_model,verbose=0)
...
#new pipeline using Keras Tensor Flow
pipelines["Xdw+KERAS_TF"] = make_pipeline(
