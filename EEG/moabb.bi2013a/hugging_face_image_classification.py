...
"""
 ...
 Provides classification of images where we use a pre-trained model and we fine-tune it on our dataset.
...
# example: pip install git+https://github.com/huggingface/transformers
