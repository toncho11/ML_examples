...
for subject in dataset.subject_list[0:17]: #[0:17]
    ...
    for i in range(0, len(epochs_subject)):
        ...
        print(single_epoch_subject_data.shape)
    
        #add to list
        epochs_all_subjects.append(single_epoch_subject_data.copy())
...
for subject in dataset.subject_list[17:]: #[17:]
    ...
    for i in range(0, len(epochs_subject)):
        ...
        #add to list
        test_epochs_all_subjects.append(single_epoch_subject_data.copy())
...
model = Sequential()
model.add(Conv2D(32, (2, 2), input_shape=(16,img_size,1)))
...
model.fit(train_images, train_labels, epochs=25, shuffle=True)
